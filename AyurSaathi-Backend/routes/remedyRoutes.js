...
const MOCK_RESPONSES = {
  cold: {
    diseaseName: "cold",
    healthTip:
      "Stay warm, drink warm liquids like ginger tea, and get plenty of rest. Avoid cold foods and drinks.",
    homeRemedies: [
      {
    ...
    yoga: [
      {
        ...
        duration: "5-10 min",
        imageKeyword: "cobra pose yoga",
        youtubeSearchQuery: "Bhujangasana cobra pose yoga tutorial",
      },
      {
        asanaName: "Kapalabhati",
        howToDo: [
          "Sit comfortably",
          "Inhale deeply",
        ...
        duration: "2-3 min",
        imageKeyword: "kapalabhati pranayama breathing",
        youtubeSearchQuery: "Kapalabhati pranayama breathing exercise tutorial",
      },
    ],
    doctorAdvice:
      "Consult a doctor if fever persists beyond 3 days or symptoms worsen.",
  },
  fever: {
    diseaseName: "fever",
    healthTip:
      "Rest, stay hydrated, and keep the room cool. Monitor temperature regularly.",
    homeRemedies: [
      {
    ...
    doctorAdvice:
      "Seek medical attention if fever exceeds 103°F or lasts more than 3 days.",
  },
  headache: {
    diseaseName: "headache",
    healthTip:
      "Rest in a quiet dark room, stay hydrated, and avoid screen time.",
    homeRemedies: [
      {
        remedyName: "Clove Paste",
        ingredients: ["4-5 cloves", "Rock salt", "Banana leaf or cloth"],
        preparationSteps: [
          "Grind cloves with rock salt",
          "Apply paste on forehead",
    ...
    yoga: [
      {
        ...
        youtubeSearchQuery:
          "Nadi Shodhana alternate nostril breathing tutorial",
      },
    ],
...
const FALLBACK_MOCK_RESPONSES = {
  ...
  "cold & flu": {
    ...
    healthTip:
      "Stay warm, drink warm fluids like kadha and ginger tea. Avoid cold foods and get adequate rest.",
    homeRemedies: [
      {
        ...
        preparationSteps: [
          "Boil water with all spices and tulsi",
      ...
      },
      {
        ...
        preparationSteps: [
          ...
          "Add eucalyptus oil",
          "Cover head with towel and inhale steam",
          "Do for 5-10 minutes",
    ...
    yoga: [
      ...
      {
        asanaName: "Kapalabhati Pranayama",
        howToDo: [
          "Sit in comfortable position with straight spine",
          "Take a deep breath in",
          "Exhale forcefully through nose, pulling navel in",
          "Let inhalation happen passively",
          "Start with 20 rounds, increase gradually",
        ],
        duration: "3-5 min",
        imageKeyword: "kapalabhati pranayama breathing",
        youtubeSearchQuery: "Kapalabhati pranayama breathing exercise tutorial",
    ...
    doctorAdvice:
      "Consult a doctor if fever exceeds 102°F, symptoms persist beyond 7 days, or you experience difficulty breathing.",
  },
  stress: {
    diseaseName: "stress",
    healthTip:
      "Follow a regular daily routine (Dinacharya). Practice mindfulness, limit screen time before bed, and include calming herbs in your diet.",
    homeRemedies: [
      {
        ...
        preparationSteps: [
          ...
          "Add ashwagandha and cardamom powder",
      ...
      },
      {
        ...
        preparationSteps: [
          "Boil water and add brahmi leaves",
      ...
      },
      {
        ...
        preparationSteps: [
          ...
          "Massage gently on temples and forehead",
    ...
    yoga: [
      {
        asanaName: "Balasana (Child Pose)",
        howToDo: [
          "Kneel on mat with big toes touching",
          "Sit back on heels",
          "Bend forward, extending arms ahead",
          "Rest forehead on mat",
          "Breathe deeply, hold for 1-3 minutes",
        ],
        duration: "5-10 min",
        imageKeyword: "child pose yoga",
        youtubeSearchQuery: "Balasana child pose yoga tutorial",
      },
      {
        asanaName: "Nadi Shodhana (Alternate Nostril Breathing)",
        howToDo: [
          ...
          "Inhale right, exhale left — one cycle",
        ],
        duration: "5-10 min",
        imageKeyword: "alternate nostril breathing yoga",
        youtubeSearchQuery:
      ...
      },
      {
        ...
        howToDo: [
          ...
          "Close eyes and relax every body part",
    ...
    doctorAdvice:
      "If stress is accompanied by persistent anxiety, insomnia, chest pain, or depression lasting more than 2 weeks, seek professional mental health support.",
  },
  digestion: {
    diseaseName: "digestion",
    healthTip:
      "Eat warm, freshly cooked food. Avoid cold drinks during meals. Chew food thoroughly and eat at regular times.",
    homeRemedies: [
      {
        ...
        preparationSteps: [
          ...
          "Alternatively, boil cumin in water for 5 minutes",
          "Strain and drink on empty stomach",
          "Can add a pinch of rock salt for taste",
        ],
      },
      {
        ...
        preparationSteps: [
          "Crush ajwain lightly",
          "Grate the ginger",
          "Add both to warm water with rock salt",
          "Mix well and drink after heavy meals",
        ],
      },
      {
    ...
    yoga: [
      {
        asanaName: "Vajrasana (Thunderbolt Pose)",
        howToDo: [
          "Kneel on mat",
          "Sit back on your heels",
          "Keep spine straight, hands on thighs",
          "Breathe normally",
          "Sit for 5-10 minutes after meals",
        ],
        duration: "5-10 min",
        imageKeyword: "vajrasana thunderbolt pose",
        youtubeSearchQuery: "Vajrasana thunderbolt pose yoga tutorial",
      },
      {
        asanaName: "Pawanmuktasana (Wind-Relieving Pose)",
        howToDo: [
          "Lie on back",
          "Bring right knee to chest",
          "Clasp hands around knee and press",
          "Lift head towards knee",
          "Hold 15-30 seconds, switch legs",
        ],
        duration: "5 min",
        imageKeyword: "wind relieving pose yoga",
        youtubeSearchQuery: "Pawanmuktasana wind relieving pose yoga tutorial",
      },
    ],
    doctorAdvice:
      "Consult a gastroenterologist if you experience persistent bloating, blood in stool, unexplained weight loss, or severe abdominal pain.",
  },
  "back pain": {
    diseaseName: "back pain",
    healthTip:
      "Maintain good posture. Avoid sitting for long periods. Sleep on a firm mattress and apply warm sesame oil to the affected area.",
    homeRemedies: [
      {
        remedyName: "Warm Sesame Oil Massage",
        ingredients: [
          "3 tbsp sesame oil",
          "1/4 tsp camphor (optional)",
          "Hot water bag",
        ],
        preparationSteps: [
          "Warm the sesame oil slightly",
          "Add camphor if using",
          "Massage gently on the lower back in circular motions",
          "Apply for 15-20 minutes",
          "Follow with a hot water bag compress",
        ],
      },
      {
        ...
        preparationSteps: [
          "Mix turmeric and ginger powder",
    ...
    yoga: [
      {
        asanaName: "Marjariasana (Cat-Cow Pose)",
        howToDo: [
        ...
        duration: "5 min",
        imageKeyword: "cat cow pose yoga",
        youtubeSearchQuery: "Marjariasana cat cow pose yoga tutorial",
      },
      {
        asanaName: "Bhujangasana (Cobra Pose)",
        howToDo: [
          ...
          "Inhale and slowly lift upper body",
          "Keep elbows slightly bent",
          "Hold for 15-30 seconds",
        ],
        duration: "5 min",
      ...
      {
        asanaName: "Setu Bandhasana (Bridge Pose)",
        howToDo: [
          "Lie on back, bend knees",
          "Place feet hip-width apart",
          "Press feet down, lift hips up",
          "Clasp hands under body",
          "Hold for 30 seconds to 1 minute",
        ],
        duration: "5 min",
        imageKeyword: "bridge pose yoga",
        youtubeSearchQuery: "Setu Bandhasana bridge pose yoga tutorial",
      },
    ],
    doctorAdvice:
      "See a doctor if back pain is accompanied by numbness in legs, loss of bladder control, or persists beyond 2 weeks despite rest.",
  },
  insomnia: {
    diseaseName: "insomnia",
    healthTip:
      "Follow a fixed sleep schedule. Avoid screens 1 hour before bed. Massage warm oil on the soles of your feet before sleeping.",
    homeRemedies: [
      {
      ...
      },
      {
        ...
        preparationSteps: [
          "Mix shankhpushpi in warm water or milk",
          "Stir well and drink",
          "Take every evening, 1 hour before sleep",
        ],
      },
      {
        ...
        preparationSteps: [
          ...
          "Massage each foot sole for 5 minutes",
          "Focus on the center of the sole",
          "Wear cotton socks after massage",
          "Do this every night before sleep",
        ],
      },
    ],
    yoga: [
      {
        asanaName: "Viparita Karani (Legs Up the Wall)",
        howToDo: [
        ...
        duration: "5-10 min",
        imageKeyword: "legs up wall pose yoga",
        youtubeSearchQuery:
          "Viparita Karani legs up the wall pose yoga tutorial",
      },
      {
        asanaName: "Yoga Nidra (Yogic Sleep)",
        howToDo: [
          "Lie in Shavasana position",
          "Close eyes, relax body part by part",
          "Follow guided body scan meditation",
          "Maintain awareness while deeply relaxed",
          "Practice for 15-20 minutes",
        ],
        duration: "15-20 min",
        imageKeyword: "yoga nidra relaxation",
        youtubeSearchQuery: "Yoga Nidra guided yogic sleep meditation",
      },
    ],
    doctorAdvice:
      "Consult a sleep specialist if insomnia persists for more than 3 weeks, or if you experience daytime fatigue affecting daily activities.",
  },
  "skin care": {
    diseaseName: "skin care",
    healthTip:
      "Drink plenty of water. Eat fresh fruits and vegetables. Avoid processed foods and excessive sugar. Apply aloe vera regularly.",
    homeRemedies: [
      {
      ...
      },
      {
        ...
        ingredients: [
          ...
          "5-6 crushed neem leaves",
          "Few drops lemon juice",
        ],
        preparationSteps: [
          "Extract fresh aloe vera gel",
          "Crush neem leaves and extract juice",
          "Mix aloe gel with neem juice and lemon",
          "Apply on affected areas",
          "Leave for 20 minutes, wash off",
        ],
      },
    ],
    yoga: [
      {
        asanaName: "Sarvangasana (Shoulder Stand)",
        howToDo: [
          "Lie on back",
        ...
        duration: "3-5 min",
        imageKeyword: "shoulder stand yoga pose",
        youtubeSearchQuery: "Sarvangasana shoulder stand yoga tutorial",
      },
      {
        asanaName: "Matsyasana (Fish Pose)",
        howToDo: [
          "Lie on back",
        ...
        duration: "3-5 min",
        imageKeyword: "fish pose yoga",
        youtubeSearchQuery: "Matsyasana fish pose yoga tutorial",
      },
    ],
    doctorAdvice:
      "Consult a dermatologist for persistent skin issues, rashes that spread, or skin conditions not improving with home remedies after 2 weeks.",
  },
  "joint pain": {
    diseaseName: "joint pain",
    healthTip:
      "Keep joints warm. Apply warm mustard or sesame oil daily. Include anti-inflammatory foods like turmeric, ginger, and garlic in your diet.",
    homeRemedies: [
      {
        remedyName: "Nirgundi Oil Massage",
        ingredients: [
          "3 tbsp nirgundi (vitex) oil",
          "or 2 tbsp mustard oil with 1/4 tsp ajwain",
        ],
        preparationSteps: [
          "Warm the oil slightly",
          "Massage on affected joints in circular motion",
      ...
      },
      {
        ...
        preparationSteps: [
          "Cook turmeric and water on low heat, stirring until it forms a paste",
          "Add coconut oil and black pepper",
          "Mix well and cool",
          "Store in glass jar in fridge",
          "Take 1/2 tsp with warm milk daily",
        ],
      },
      {
        ...
        preparationSteps: [
          ...
          "You can chew the soaked seeds too",
    ...
    yoga: [
      {
        ...
        howToDo: [
          ...
          "Bend to the right, touch right ankle",
          "Look up at left hand, hold 30 seconds",
        ],
        duration: "5 min",
        imageKeyword: "triangle pose yoga",
        youtubeSearchQuery: "Trikonasana triangle pose yoga tutorial",
      },
      {
        asanaName: "Virabhadrasana (Warrior Pose)",
        howToDo: [
          "Stand with feet 3-4 feet apart",
          "Turn right foot out, bend right knee",
          "Keep left leg straight",
          "Raise arms overhead",
          "Hold for 30 seconds, switch sides",
        ],
        duration: "5-10 min",
        imageKeyword: "warrior pose yoga",
        youtubeSearchQuery: "Virabhadrasana warrior pose yoga tutorial",
      },
    ],
    doctorAdvice:
      "Consult an orthopedic specialist if joint pain is severe, accompanied by swelling, redness, or limits your mobility significantly.",
  },
  cough: {
    diseaseName: "cough",
    healthTip:
      "Keep your throat moist. Avoid cold water and dairy products at night. Gargle with warm salt water.",
    homeRemedies: [
      {
        ...
        preparationSteps: [
          ...
          "Take 1 teaspoon slowly, letting it coat the throat",
          "Repeat 2-3 times daily",
      ...
      },
      {
        ...
        preparationSteps: [
          "Break mulethi into small pieces",
    ...
    yoga: [
      {
        asanaName: "Simhasana (Lion Pose)",
        howToDo: [
          "Kneel and sit on heels",
          "Place palms on knees",
          "Open mouth wide, stick tongue out",
          "Exhale with a roaring sound",
          "Repeat 5-6 times",
        ],
        duration: "3-5 min",
        imageKeyword: "lion pose yoga",
        youtubeSearchQuery: "Simhasana lion pose yoga tutorial",
      },
      {
        asanaName: "Ustrasana (Camel Pose)",
        howToDo: [
        ...
        duration: "3-5 min",
        imageKeyword: "camel pose yoga",
        youtubeSearchQuery: "Ustrasana camel pose yoga tutorial",
      },
    ],
    doctorAdvice:
      "See a doctor if cough persists for more than 2 weeks, produces blood, or is accompanied by chest pain.",
  },
  acne: {
    diseaseName: "acne",
    healthTip:
      "Keep face clean, avoid oily and spicy foods, drink plenty of water, and never pop pimples.",
    homeRemedies: [
      {
        remedyName: "Neem & Turmeric Paste",
        ingredients: [
          "Fresh neem leaves (handful)",
          "1/4 tsp turmeric",
          "Rose water",
        ],
        preparationSteps: [
    ...
    yoga: [
      {
        ...
        howToDo: [
          "Lie on back",
          "Lift legs overhead with hand support on lower back",
          "Keep body straight and hold",
          "Improves blood circulation to face",
        ],
        duration: "2-5 min",
        imageKeyword: "shoulder stand yoga pose",
        youtubeSearchQuery: "Sarvangasana shoulder stand yoga tutorial",
    ...
    doctorAdvice:
      "Consult a dermatologist for severe or cystic acne, or if over-the-counter remedies do not work after 4-6 weeks.",
  },
  anxiety: {
    diseaseName: "anxiety",
    healthTip:
      "Practice mindfulness daily. Reduce caffeine intake. Maintain a regular sleep schedule and spend time in nature.",
    homeRemedies: [
      {
        ...
        preparationSteps: [
          "Steep chamomile bag in hot water for 5 mins",
          "Add ashwagandha powder and stir",
          "Add honey to taste",
    ...
    yoga: [
      ...
      {
        asanaName: "Anulom Vilom (Alternate Nostril Breathing)",
        howToDo: [
          "Sit comfortably",
        ...
        duration: "5-10 min",
        imageKeyword: "anulom vilom pranayama",
        youtubeSearchQuery: "Anulom Vilom alternate nostril breathing tutorial",
      },
    ],
    doctorAdvice:
      "Professional therapy is recommended for chronic anxiety. Seek immediate help if anxiety causes panic attacks or interferes with daily life.",
  },
};
